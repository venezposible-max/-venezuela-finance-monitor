...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
    if (message.action === 'triggerAlarm') {
        // Enviar notificación de Chrome de alta prioridad
        chrome.notifications.create('bt-intervention-alert', {
            type: 'basic',
            iconUrl: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=',
            title: '🚨 ¡INTERVENCIÓN DETECTADA! 🚨',
            message: 'Se ha habilitado la opción Ordinaria en el Banco del Tesoro.',
            priority: 2,
            requireInteraction: true // Requiere que el usuario la cierre manualmente
        });
